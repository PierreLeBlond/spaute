...
<div class="flex flex-col">
  <div class="relative grid grid-cols-5 items-center justify-center">
    <label
      for="{name}-input"
      class="col-span-2 text-xs">{label}</label
    >
    {#if !checked}
      <p
        transition:fade|local
        class="col-start-3 text-center text-red-300"
      >
        non
      </p>
    {/if}
