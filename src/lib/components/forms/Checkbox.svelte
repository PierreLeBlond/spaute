  ...
  <div class="relative grid h-8 grid-cols-3 items-center justify-center">
    {#if !checked}
      <p
        ...
        class="col-start-1 text-center text-red-300"
      >
        non
      </p>
    {/if}
