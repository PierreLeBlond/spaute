...
-- CreateIndex
CREATE UNIQUE INDEX "auth_user_playerId_key" ON "auth_user"("playerId");
...
-- AddForeignKey
ALTER TABLE "auth_user" ADD CONSTRAINT "auth_user_playerId_fkey" FOREIGN KEY ("playerId") REFERENCES "Player"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
